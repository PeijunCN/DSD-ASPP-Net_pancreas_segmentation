...
root = '/home/hup/hu/Myproject/pytorch-semantic-segmentation-master/datasets/VOC'
...
def make_dataset(mode):
    ...
    if mode == 'train':
        ...
        data_list = [l.strip('\n') for l in open(os.path.join(
            root, 'VOCdevkit', 'VOC2012', 'ImageSets', 'Segmentation', 'seg11valid2.txt')).readlines()]
        for it in data_list:
...
class VOC(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.sliding_crop is not None:
            ...
            #print("img_slices",len(img_slices)) #2
