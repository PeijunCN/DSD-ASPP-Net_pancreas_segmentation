...
data_transforms1 = transforms.Compose([transforms.ToTensor()])
    ...
    def folder_inference(self, img_dir, is_multiscale=True):
        ...
        for f in folders:
            ...
            for n in names:
                ...
                #read_name='/home/hup/hu/MedicalData/pancreas/pic2/pancreas_jpg/10001_10003.jpg';
                img = Image.open(read_name).convert('RGB')
                if is_multiscale:
