...
path2 = '/home/hupj82/Data/npy_coarse/' #prediction as .npz
result_path = '/home/hupj82/Data/npy_coarse/fusion/'
...
for i in range(82):
    ...
    if not os.path.isfile(volume_file_F1):
        #pred_total = 3/4*pred_X + 3/4*pred_Y + 6/4*pred_Z
