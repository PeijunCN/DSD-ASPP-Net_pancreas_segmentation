...
from datasets import fast_functions
#import fast_functions as ff
from datasets import fast_functions as ff
...
def result_name_from_timestamp(result_path, current_fold, \
	...
	#print(os.path.join(result_path, result_name, 'volumes'))
...
data_path = '/home/hup/hu/Myproject/OrganSegRSTN_PyTorch-master/DATA2NPY/'
